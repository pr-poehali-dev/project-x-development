export function Footer() {
  const footerLinks = {
    "Продукция": ["Бытовая химия", "Автохимия", "Химия для клининга", "Каталог", "Сертификаты"],
    "Компания": ["О компании", "Производство", "Качество", "Партнёры", "Новости"],
    "Партнёрам": ["Стать дистрибьютором", "Оптовые поставки", "Заказать прайс", "Специальные условия"],
    "Документы": ["Инструкции по применению", "Паспорта безопасности", "Сертификаты", "Декларации"],
    "Контакты": ["Связаться с нами", "Офис и склад", "Реквизиты", "Политика конфиденциальности"],
  }
